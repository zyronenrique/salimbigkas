...
export const doGetAllClassMembersGrade = async (classId: string) => {
  try {
    const getAllClassMembersGrade = httpsCallable(
      functions,
      "getAllClassMembersGrade",
    );
    const response = await getAllClassMembersGrade({ classId });
    return response.data;
  } catch (error) {
...
export const doCreateSeatworkorQuiz = async (
  ...
  try {
    const createSeatworkorQuiz = httpsCallable(functions, "setCreateSeatworkorQuiz");
    const response = await createSeatworkorQuiz({
      signInUser,
      classId,
      yunitId,
      yunitNumber,
...
export const doSubmitQuizAnswers = async (
  signInUser: string,
  category: string,
...
export const doSubmitSeatworkAnswers = async (
  signInUser: string,
  category: string,
  classId: string | null = null,
  quizId: string,
  ...
  try {
    ...
    const response = await submitSeatworkAnswers({
      signInUser,
      category,
      classId,
      quizId,
